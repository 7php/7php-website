...
- Contributions: If you find any typos, let me know via [email me]({{ site.site_url }}{% link pages/contact.md %}) or tweet to @7php
- Contributions: I need this article to be translated to French or Bulgarian or {your_language} - if you want to contribute, please get in touch.